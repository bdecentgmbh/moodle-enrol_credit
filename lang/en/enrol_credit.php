...
$string['credit:managecredits'] = 'Manage user course credits (add credits via web service)';
...
$string['enrolfailed'] = 'Enrolment failed. No credits have been deducted.';
...
$string['error_creditcost'] = 'The credit cost must be zero or a positive number.';
...
$string['privacy:metadata'] = 'The Course Credit enrolment plugin does not store any personal data of its own. Credit balances are stored in a site-defined custom user profile field and enrolments in the core enrolment tables, both of which are managed and exported by Moodle core.';
