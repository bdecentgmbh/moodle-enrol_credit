...
class deleteselectedusers_operation extends \enrol_bulk_enrolment_operation {
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_credit');

        return new \enrol_credit\deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(\course_enrolment_manager $manager, array $users, \stdClass $properties) {
        if (!has_capability("enrol/credit:unenrol", $manager->get_context())) {
            return false;
        }
