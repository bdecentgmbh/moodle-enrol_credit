...
class editselectedusers_operation extends \enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('editselectedusers', 'enrol_credit');
    }
    ...
    public function process(\course_enrolment_manager $manager, array $users, \stdClass $properties) {
        ...
        if (!has_capability("enrol/credit:manage", $manager->get_context())) {
            return false;
        }
     ...
     * @return \enrol_credit\editselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        return new \enrol_credit\editselectedusers_form($defaultaction, $defaultcustomdata);
    }
}
